...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(firstName, lastName, email, password) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"buyCourse.js":[function(require,module,exports) {
"use strict";
...
var buyCourse = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(courseSlug) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "/api/v1/courses/buyCourse/".concat(courseSlug)
          });
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "You have succesfully bought the course");
            window.setTimeout(function () {
              location.assign("/");
            }, 1500);
          } else {
...
var _buyCourse = require("./buyCourse");
var signupBtn = document.getElementById("signup-btn");
var loginBtn = document.getElementById("login-btn");
var subjectButtton = document.getElementById("subject-enroll");
var buyCourseBtn = document.getElementById("buyCourse");
if (signupBtn) {
  signupBtn.addEventListener("click", function (e) {
    ...
    (0, _loginSignup.signup)(firstName, lastName, email, password);
  });
}
if (loginBtn) {
...
if (subjectButtton) {
  subjectButtton.addEventListener("click", function (e) {
    e.preventDefault();
    var subject = e.target.dataset.subject; // e.target is button which was clicked
